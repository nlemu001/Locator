...
public class UploadModel extends TransferModel {
    ...
    public void upload() {
        ...
        if (mFile != null) {
            try {
            	...
            	Integer id = ((Member) this.my_context.getApplicationContext()).ID;
    ...
    private void saveTempFile() {
        ...
        try {
            ...
            bd = BitmapFactory.decodeStream(in);
            bd = Bitmap.createScaledBitmap(bd, 200, 200, true);
            bd.compress(CompressFormat.JPEG, 40, out);
